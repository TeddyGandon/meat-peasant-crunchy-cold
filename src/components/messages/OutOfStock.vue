  ...
  <div>
    <div class="w-full h-full absolute top-0 left-0">
      ...
      <div class="w-full h-full absolute top-0 left-0 text-white flex h-screen p-12">
        <div class="m-auto">
          <p class="text-center text-4xl mb-6 fade-in delay-1">Dear peasant, you sold everything!</p>
...
@Component
export default class OutOfStock extends Vue {
  ...
  public endDay(): void {
    this.$store.dispatch('app/resolveOutOfStock');
